...
function endpoint_kranot(){
   wp_localize_script('jquery','kranot',array(
     'ajax' => admin_url('admin-ajax.php')
   ));
}

add_action('wp_enqueue_scripts', 'endpoint_kranot');


add_shortcode('kranot_form', function () { // insurance form shortcode
  ob_start();
  kranot_form_html();
  return ob_get_clean();
});
...
<div class="tab">
 ...
 <label id="validtext" align="right">נא מלא את כל השדות</label>
  ...
  <div class="step" display="block">
    ...
    <label><input type="radio" name="gil" class="item-list" value="עד 50"  ><span>עד 50</span></label>
  ...
  <label><input type="radio" name="gil" class="item-list" value="מעל 75"  ><span>מעל 75</span></label>
    ...
    <div class="step" style="display: none;">
     <label  class="koteret" align="right">באילו בתי השקעות נמצאות קרנות ההשתלמות או קופות הגמל שלך?</label>
   <div  class="blocks"> 
    
    <label><input type="radio" name="keren" class="item-list" value="אלטשולר שחם"  ><span>אלטשולר שחם</span></label>
    <label><input type="radio" name="keren" class="item-list" value="בית השקעות מור"  ><span>בית השקעות מור</span></label>
     <label><input type="radio" name="keren" class="item-list" value="ילין לפידות"  ><span>ילין לפידות</span></label>
     <label><input type="radio" name="keren" class="item-list" value="כלל" ><span>כלל</span></label>
     <label><input type="radio" name="keren" class="item-list" value="מיטב דש" ><span>מיטב דש</span></label>
     <label><input type="radio" name="keren" class="item-list" value="אקסלנס הפניקס" ><span>אקסלנס הפניקס</span></label>
     <label><input type="radio" name="keren" class="item-list" value="הלמן אלדובי" ><span>הלמן אלדובי</span></label>
     <label><input type="radio" name="keren" class="item-list" value="מגדל" ><span>מגדל</span></label>
     <label><input type="radio" name="keren" class="item-list" value="הראל" ><span>הראל</span></label>
     <label><input type="radio" name="keren" class="item-list" value="אנליסט" ><span>אנליסט</span></label>
     <label><input type="radio" name="keren" class="item-list" value="פסגות" ><span>פסגות</span></label>
     <label><input type="radio" name="keren" class="item-list" value="מנורה" ><span>מנורה</span></label>
     <label><input type="radio" name="keren" class="item-list" value="אחר" ><span>אחר</span></label>
  ...
  <div class="step" style="display: none;">
    ...
    <label  class="koteret" align="right">לצורך בדיקת הזכאות אצטרך הערכה של גובה הצבירות הקיימות.
להערכתך, מהו השווי הכולל המשוער של קרנות ההשתלמות וקופות הגמל שברשותך?</label>
   <div  class="blocks"> 
    
  <label><input type="radio" name="savings" class="item-list" value="מעל 2 מיליון שקלים"  ><span>מעל 2 מיליון ₪</span></label>
  <label><input type="radio" name="savings" class="item-list" value="בין 1 ל-2 מיליון שקלים"  ><span>בין 1 ל-2 מיליון ₪</span></label>
  <label><input type="radio" name="savings" class="item-list" value="בין 500 אלף למיליון שקלים"  ><span>בין 500 אלף למיליון ₪</span></label>
  <label><input type="radio" name="savings" class="item-list" value="בין 300 ל500 אלף שקלים"  ><span>בין 300 ל500 אלף ₪</span></label>
	 <label><input type="radio" name="savings" class="item-list" value="בין 200 ל300 אלף שקלים"  ><span>בין 200 ל300 אלף ₪</span></label>
     <label><input type="radio" name="savings" class="item-list" value="בין 100 ל200 אלף שקלים"  ><span>בין 100 ל200 אלף ₪</span></label>
     <label><input type="radio" name="savings" class="item-list" value="בין 50 ל100 אלף שקלים"  ><span>בין 50 ל100 אלף ₪</span></label>
     <label><input type="radio" name="savings" class="item-list" value="אין לי כסף נזיל"  ><span>אין לי כסף נזיל</span></label>
  ...
  <div class="step" style="display: none;">
     ...
     <label  class="koteret" align="right">מתי בדקת לאחרונה את ביצועיי (דמי ניהול ותשואה) של הקרנות או הקופות שלך?</label>
    
        <div  class="blocks"> 
    
    <label><input type="radio" name="last_checked" class="item-list" value="בשנה האחרונה"  ><span>בשנה האחרונה</span></label>
  <label><input type="radio" name="last_checked" class="item-list" value="לפני יותר משנה" ><span>לפני יותר משנה</span></label>
  <label><input type="radio" name="last_checked" class="item-list" value="לפני יותר משנתיים"  ><span>לפני יותר משנתיים</span></label>
  <label><input type="radio" name="last_checked" class="item-list" value="לא זוכר"  ><span>לא זוכר</span></label>
  ...
  debugger
      ...
      function sendDataCrm(){
       ...
       const age = jQuery('input[name="gil"]:checked').val();
        ...
        const keren = jQuery('input[name="keren"]:checked').val();
        const savings = jQuery('input[name="savings"]:checked').val();
        const last_checked = jQuery('input[name="last_checked"]:checked').val();
      ...
      jQuery.ajax({
       ...
       url: kranot.ajax,
        ...
        /// location.replace('https://www.tiktax.co.il/?page_id=191');
          else window.location = "https://nownet.co.il/?page_id=483";
        },
      })
      }
...
function send_data_crm3()
{
 ...
 $data = [
   ...
   // 'name' =>  $_POST['name'], // status
    ...
    'fld_210188' =>  $_POST['fld_210188'], 
    'fld_210189' =>  $_POST['fld_210189'], //salary_partner
    'fld_210190' =>  $_POST['fld_210190'],
...
add_action('wp_ajax_send_data_crm3','send_data_crm3');
add_action('wp_ajax_nopriv_send_data_crm3','send_data_crm3');


function send_sms_kranot(){
...
function check_code_kranot(){
 $code_user = $_POST['code_input'];
 $codeSend =  $_SESSION['code'];
 $current_code =  $codeSend === $code_user;
 if($current_code) success_sms_kranot();
 echo $current_code;  
  wp_die();
}
add_action('wp_ajax_check_code_kranot','check_code_kranot');
add_action('wp_ajax_nopriv_check_code_kranot','check_code_kranot');
  

function success_sms_kranot(){
